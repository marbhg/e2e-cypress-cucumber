...
And the user selects option "b" on question number "3"
And the user selects option "a" on question number "4"
...
And the user should see score "2" for question "3"
And the user should see score "2" for question "4"
And the user should see score "2" for question "5"
And the user should see score "pregunta" for question "6"
...
When the user fills in the first name "Marbelis"
And  the user fills in the last name "Hugo"
Then the user press submit button 
When the user selects option "c" on question number "1"
And the user selects option "c" on question number "2"
And the user selects option "b" on question number "5"
And the user selects option "a" on question number "6"
And the user selects option "c" on question number "7"
And the user selects option "c" on question number "8"
Then the user click on the Evaluate everything button 
Then the user must see the score in "red" if they are approved 
